    ...
    <div className="flex flex-1 flex-col items-center px-5 py-16 md:px-6 md:py-22">
      <div className="flex w-full max-w-82 flex-col items-center gap-6 md:max-w-130 md:gap-6.75">
        ...
        >
          ...
          {step === 1 ? <BasicInfoStep form={form} onChange={patchForm} /> : null}
          {step === 2 ? <SchoolInfoStep form={form} onChange={patchForm} /> : null}
          {step === 3 ? <GradeStep form={form} onChange={patchForm} /> : null}
          {step === 4 ? <PartStep form={form} onChange={patchForm} /> : null}
          {step === 5 ? <MotivationStep form={form} onChange={patchForm} /> : null}
          {step === 6 ? <PortfolioStep form={form} onChange={patchForm} /> : null}
