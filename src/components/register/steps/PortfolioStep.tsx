  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <TextField
        ...
        state={form.portfolioUrl && !isValidUrl(form.portfolioUrl) ? "error" : "default"}
        hint={
      ...
      <TextField
        ...
        state={form.githubUrl && !isValidUrl(form.githubUrl) ? "error" : "default"}
        hint={
          form.githubUrl && !isValidUrl(form.githubUrl) ? "올바른 URL을 입력해주세요" : undefined
        }
      />
    </div>
  );
